...
-- consumer_c / 123456
INSERT INTO sys_user (domain_id, username, password_hash, role_type) VALUES
...
INSERT INTO sys_topic_acl (client_id, topic_filter, action, access_type) VALUES
  ('producer_swu_*', '/cross_domain/medical/hosp_swu/#', 'publish', 'allow'),
  ('consumer_social_*', '/cross_domain/medical/#', 'subscribe', 'allow'),
  ('admin_*', '/cross_domain/#', 'all', 'allow'),
  ('consumer_c_*', '/cross_domain/enterprise/#', 'subscribe', 'allow'),
  ('*', '#', 'all', 'deny');
